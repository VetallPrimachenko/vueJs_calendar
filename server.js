...
let events = [
	{description: 'Random Event 1', date: moment('2018-07-15', 'YYYY-MM-DD')},
	{description: 'Random Event 2', date: moment('2018-07-6', 'YYYY-MM-DD')},
	{description: 'Random Event 3', date: moment('2018-07-20', 'YYYY-MM-DD')}
];
let renderer;
